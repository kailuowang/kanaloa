 ...
 *  It internally publishes these [[QueueSample]]s as well as [[PartialUtilization]] data
 ...
 *  It publishes [[QueueSample]]s and [[PartialUtilization]] number to subscribers.
 *
 */
...
private[kanaloa] object QueueSampler {
  ...
  case object PartialUtilization extends Report
